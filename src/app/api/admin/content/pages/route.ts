...
import { StaticPageCreateSchema } from '@/lib/schemas/admin-staticpage';
import { createStaticPage } from '@/server/admin/cms/staticpage-service';
...
export async function POST(req: Request): Promise<Response> {
  ...
  const parsed = StaticPageCreateSchema.safeParse(body);
