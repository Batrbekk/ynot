...
describe('<StockEditor>', () => {
  ...
  it('renders 5 rows for XS S M L XL', () => {
    render(<StockEditor productId="p1" initial={[]} />);
  ...
  it('preloads initial stock', () => {
    render(<StockEditor productId="p1" initial={[{ size: 'M', stock: 7 }]} />);
  ...
  it('on save PATCHes /sizes with full set', async () => {
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
