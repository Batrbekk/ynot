...
interface Props {
  id: string;
  initial: { src: string; alt: string; productSlug: string | null };
}

export function LookbookEditForm({ id, initial }: Props): React.ReactElement {
  ...
  const [productSlug, setProductSlug] = React.useState(initial.productSlug ?? '');
  ...
  function onSubmit(e: React.FormEvent<HTMLFormElement>): void {
    ...
    startTransition(async () => {
      const res = await fetch(`/api/admin/content/lookbook/${id}`, {
        method: 'PATCH',
